...
- 装備: 剣2種（Bronze Sword）、盾2種（Wood Shield）
- NPC: 王様、商人、宿屋主人
- クリア条件: Ancient Key入手 → 遺跡到達
...
【第一章：鍛冶屋救出編】5. 南人で銅の剣・盾を購入 → 装備強化 6. 洞窟1へ進入（1層→2層）7. 洞窟12層で鍛冶屋を発見 → 魔物と戦闘 8. 鍛冶屋を救出成功（Phase 0→1）
   • 「助けてくれてありがとう。だが聖虹石は無かった」

9. 街へ帰還
10. 鍛冶屋と会話 → 「力のハンマー」入手
   • 「岩壁を砕く力がある。東の海岸にも塞がれた洞窟があったな」

【第二章：聖虹石発見編】11. 東の洞窟へ → 洞窟2入口を発見（岩で塞がれている）12. 力のハンマーを使用 → 岩を破壊、洞窟2へ進入可能に 13. 洞窟2で戦闘と宝箱発見 → さらに奥深強化 14. 洞窟2攻略（1層→2層）※新モンスター3種（アイアンゴーレム、ダークエレメンタル、デスナイト）15. 洞窟22層の宝箱から「聖虹石」入手（Phase 1→2）

【第三章：聖剣錬成編】16. 街へ帰還 → 鍛冶屋に聖虹石を見せる→「これだ！聖虹石だ！鉄の剣を作ってくる」17. 南人から「鉄の剣」を購入（まだ買っていなければ）18. 鍛冶屋へ → 鉄の剣・聖虹石で錬成 19.「聖剣」完成！装備（Phase 2→3）

【第四章：聖盾完全編】20. 王様と会話（Phase 3）→ 聖剣を見せる→「よく聖剣を手に入れた。これを授けよう」21.「聖盾」入手！装備 22. 神父でセーブ → 最終決戦前の準備

【最終章：竜討伐編】23. 遺跡1層へ進入 ※新モンスター3種（ストーンガーディアン、カースドアーマー、シャドウビースト）24. 遺跡2層へ進む → 最深部の王座の間へ 25. 古代竜と決戦 ※聖剣・聖盾がないとダメージが通らない/防げない 26. 竜を倒す → 遺跡に平和が訪れる（Phase 3→4）27. 王様に報告 → ゲームクリア・「勇者よ、島を救ってくれてありがとう！」
...
| SPIDER（蜘蛛） | FIELD | 20-26 | 4-6 | 1-2 | 9-12 | 12-16 |
| GHOST（ゴースト） | CAVE（洞窟1） | 28-34 | 6-7 | 2-3 | 12-16 | 16-20 |
| VAMPIRE（ヴァンパイア） | CAVE（洞窟1） | 36-44 | 7-9 | 3-4 | 18-24 | 22-28 |
| TROLL（トロール） | CAVE（洞窟1） | 48-58 | 9-11 | 4-5 | 24-32 | 28-36 |
| DRAGON（ドラゴン） | FIELD固定 | 60-80 | 9-11 | 4-5 | 30-40 | 35-50 |

### 追加モンスター（洞窟2） ⭐

| 敵 | 出現場所 | HP | ATK | DEF | EXP | Gold |
|---|---|---|---|---|---|---|
| **IRON_GOLEM**（アイアンゴーレム） ⭐ | CAVE_B2（洞窟2） | 55-65 | 8-10 | 5-6 | 28-35 | 30-40 |
| **DARK_ELEMENTAL**（ダークエレメンタル） ⭐ | CAVE_B2（洞窟2） | 50-60 | 10-12 | 3-4 | 30-38 | 32-42 |
| **DEATH_KNIGHT**（デスナイト） ⭐ | CAVE_B2（洞窟2） | 65-75 | 11-13 | 5-7 | 35-45 | 38-48 |

### 追加モンスター（遺跡） ⭐

| 敵 | 出現場所 | HP | ATK | DEF | EXP | Gold |
|---|---|---|---|---|---|---|
| **STONE_GUARDIAN**（ストーンガーディアン） ⭐ | RUINS（遺跡） | 70-80 | 12-14 | 6-8 | 40-50 | 42-55 |
| **CURSED_ARMOR**（カースドアーマー） ⭐ | RUINS（遺跡） | 75-85 | 13-15 | 7-9 | 45-55 | 48-60 |
| **SHADOW_BEAST**（シャドウビースト） ⭐ | RUINS（遺跡） | 80-90 | 14-16 | 8-10 | 50-60 | 52-65 |

### ボス（遺跡最深部）

| 敵 | 出現場所 | HP | ATK | DEF | EXP | Gold | 備考 |
|---|---|---|---|---|---|---|---|
| ANCIENT_DRAGON（古代竜） | RUINS 2層 | 120-150 | 18-22 | 10-12 | 100-150 | 100-200 | 聖剣・聖盾必須 |
...
| **CAVE_B2**（洞窟1 地下2階） | CAVE_B2 | 24x18 | 洞窟1の最深部、宝箱あり（既存） |
...
| **RUINS**（遺跡 1層） ⭐ | RUINS | 24x18 | 古代遺跡、最高難易度 |
| **RUINS_B2**（遺跡 地下2階） ⭐ | RUINS_B2 | 24x18 | 遺跡の最深部、古代竜との決戦場 |
...
| アイテム | ATK | 価格 | 入手方法 | 追加 |
|---------|-----|------|---------|-----|
| Wood Sword（木の剣） | +2 | 10 Gold | 商人 | 既存 |
| Bronze Sword（銅の剣） | +4 | 40 Gold | 商人 | 既存 |
| **Iron Sword**（鉄の剣） ⭐ | **+6** | **80 Gold** | **商人** | **⭐** |
| **Holy Sword**（聖剣） ⭐ | **+10** | **-** | **鍛冶屋が錬成** | **⭐** |

### 装備アイテム（盾）

| アイテム | DEF | 価格 | 入手方法 | 追加 |
|---------|-----|------|---------|-----|
| Wood Shield（木の盾） | +2 | 10 Gold | 商人 | 既存 |
| Bronze Shield（銅の盾） | +4 | 35 Gold | 商人 | 既存 |
| **Iron Shield**（鉄の盾） ⭐ | **+6** | **70 Gold** | **商人** | **⭐** |
| **Holy Shield**（聖盾） ⭐ | **+10** | **-** | **王様から授与** | **⭐** |

### ストーリーアイテム

| アイテム | 入手方法 | 用途 | 追加 |
|---------|---------|------|-----|
| Ancient Key | 洞窟1 地下2階の宝箱 | 遺跡の扉を開く（旧ストーリー） | 既存 |
| **Power Hammer**（力のハンマー） ⭐ | **鍛冶屋救出後にもらう** | **洞窟2の入口の岩を破壊** | **⭐** |
| **Holy Ore**（聖鉱石） ⭐ | **洞窟2 地下2階の宝箱** | **聖剣の錬成材料** | **⭐** |
...
- 遺跡の入口：フィールドの西側（既存の遺跡タイルを入口に変更）
- 各MAPに階段（上り・下り）を配置
- 宝箱配置：洞窟2 地下2階に聖鉱石

**実装ファイル**:
- `map_data.js`（MAP定義追加、遷移設定追加）
...
**実装内容**:
- 剣：Iron Sword（鉄の剣 ATK+6）、Holy Sword（聖剣 ATK+10）
- 盾：Iron Shield（鉄の盾 DEF+6）、Holy Shield（聖盾 DEF+10）
- 商人の販売リストに鉄の剣・盾を追加
- 聖剣は鍛冶屋が錬成（イベントアイテム）
- 聖盾は王様が授与（イベントアイテム）
...
- ✅ セーブ・ロードが正常に機能する
- ✅ 死亡時、神父の教会で復活し、Gold/Foodが半減する
- ✅ 洞窟2と遺跡の各2層が追加され、遷移が正常に動作する
- ✅ 新モンスター6種が正しく出現し、戦闘が可能
- ✅ 鉄の剣・盾、聖剣・聖盾が入手でき、装備できる
- ✅ 鍛冶屋救出→力のハンマー入手→洞窟2解放→聖鉱石入手→聖剣錬成の流れが動作する
- ✅ 王様から聖盾を授与され、遺跡のボス戦に挑める
- ✅ 古代竜を倒してゲームクリアできる
- ✅ すべてのNPCセリフがストーリーフェーズに応じて変化する

---

**📅 最終更新日**: 2025-11-14（追加開発設計書として全面改訂）
