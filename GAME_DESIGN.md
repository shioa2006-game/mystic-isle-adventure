...
5. 南人で銅の剣・盾を購入 → 装備強化 
6. 洞窟1へ進入（1層→2層）
7. 洞窟12層で鍛冶屋を発見 → 魔物と戦闘 
8. 鍛冶屋を救出成功（Phase 0→1）
   • 「助けてくれてありがとう。だが聖虹石は無かった」
9. 街へ帰還
10. 鍛冶屋と会話 → 「力のハンマー」入手
   • 「岩壁を砕く力がある。東の海岸にも塞がれた洞窟があったな」
【第二章：聖虹石発見編】
11. 東の洞窟へ → 洞窟2入口を発見（岩で塞がれている）
12. 力のハンマーを使用 → 岩を破壊、洞窟2へ進入可能に 
13. 洞窟2で戦闘と宝箱発見 → さらに奥深強化 
14. 洞窟2攻略（1層→2層）※新モンスター3種（アイアンゴーレム、ダークエレメンタル、デスナイト）
15. 洞窟22層の宝箱から「聖虹石」入手（Phase 1→2）
【第三章：聖剣錬成編】
16. 街へ帰還 → 鍛冶屋に聖虹石を見せる→「これだ！聖虹石だ！鉄の剣を作ってくる」
17. 南人から「鉄の剣」を購入（まだ買っていなければ）
18. 鍛冶屋へ → 鉄の剣・聖虹石で錬成 
19.「聖剣」完成！装備（Phase 2→3）
【第四章：聖盾完全編】
20. 王様と会話（Phase 3）→ 聖剣を見せる→「よく聖剣を手に入れた。これを授けよう」
21.「聖盾」入手！装備 
22. 神父でセーブ → 最終決戦前の準備
【最終章：竜討伐編】
23. 遺跡1層へ進入 ※新モンスター3種（ストーンガーディアン、カースドアーマー、シャドウビースト）
24. 遺跡2層へ進む → 最深部の王座の間へ 
25. 古代竜と決戦 ※聖剣・聖盾がないとダメージが通らない/防げない 
26. 竜を倒す → 遺跡に平和が訪れる（Phase 3→4）
27. 王様に報告 → ゲームクリア・「勇者よ、島を救ってくれてありがとう！」
