...
14. 洞窟2で戦闘と宝箱発見 → さらに奥深強化 
15. 洞窟2攻略（1層→2層）※新モンスター3種（アイアンゴーレム、ダークエレメンタル、デスナイト）
16. 洞窟22層の宝箱から「聖虹石」入手（Phase 1→2）

【第三章：聖剣錬成編】
17. 街へ帰還 → 鍛冶屋に聖虹石を見せる→「これだ！聖虹石だ！鉄の剣を作ってくる」
18. 南人から「鉄の剣」を購入（まだ買っていなければ）
19. 鍛冶屋へ → 鉄の剣・聖虹石で錬成 
...
FIELD（フィールド）──→ TOWN（街）──→ CAVE（洞窟1 1層）──→ CAVE_B2（洞窟1 地下2階）──→ CAVE2（洞窟2 1層）⭐ ※力のハンマーで岩を破壊後 ──→ CAVE2_B2（洞窟2 地下2階）⭐ ──→ RUINS（遺跡 1層）⭐ ──→ RUINS_B2（遺跡 地下2階）⭐
