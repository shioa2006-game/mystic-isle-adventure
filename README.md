...
- シーン: 8つの相互接続されたマップ (FIELD, TOWN, CAVE, CAVE_B2, CAVE2, CAVE2_B2, RUINS, RUINS_B2)
- 言語: 日本語（すべてのUI/メッセージ）
...
- **FIELD（フィールド）** - 島全体。探索、戦闘、各施設への入口がある。遺跡🏛️が最終目標
- **TOWN（街）** - 安全地帯。商人🧙‍♂️、宿屋、王様👑、神父⛪、鍛冶屋🔨（救出後）がいる
...
- **RUINS（遺跡1階）** - 古代遺跡の第1階層。最強の敵が出現
- **RUINS_B2（遺跡2階）** - 遺跡の最深部。古代竜との決戦場
...
| `map_data.js` | 328 | 4シーンのタイル定義、スポーン地点、入口/出口設定 |
...
- **装備** - 武器スロット1つと盾スロット1つ。装備中のアイテムは売却不可
  - **剣**: Wood Sword（ATK+2）、Bronze Sword（ATK+4）、Iron Sword（ATK+6）、Holy Sword（ATK+10）
  - **盾**: Wood Shield（DEF+2）、Bronze Shield（DEF+4）、Iron Shield（DEF+6）、Holy Shield（DEF+10）
...
### ラスボス
- **DRAGON（古代竜）** - 遺跡2階の最深部に固定出現。聖剣・聖盾がないと倒せない
...
| GHOST | CAVE1 | 28-34 | 6-7 | 2-3 | 12-16 | 16-20 |
| WOLF | CAVE1 | 24-32 | 5-6 | 1-2 | 10-14 | 14-18 |
| SKELETON | CAVE1 | 32-40 | 6-7 | 2-3 | 14-18 | 18-22 |
| LIZARDMAN | CAVE2 | 40-48 | 8-10 | 3-4 | 20-26 | 24-30 |
| VAMPIRE | CAVE2 | 36-44 | 7-8 | 3-4 | 18-24 | 22-28 |
| TROLL | CAVE2 | 48-58 | 9-11 | 4-5 | 24-32 | 28-36 |
| GOLEM | RUINS | 70-80 | 12-14 | 6-7 | 40-50 | 42-50 |
| DARK_KNIGHT | RUINS | 75-85 | 13-15 | 7-8 | 45-55 | 48-60 |
| REAPER | RUINS | 80-90 | 14-16 | 8-10 | 50-60 | 52-65 |
| DRAGON | RUINS_B2固定 | 120-150 | 18-22 | 10-12 | 100-150 | 100-150 |
...
- **レベルアップ時の効果**：
  ...
  - 偶数レベル時：ATK+1
  - 奇数レベル時：DEF+1
- **必要経験値の計算式**：`5 × レベル × (レベル - 1)`
  - LV2=10 / LV3=30 / LV4=60 / LV5=100 / LV6=150 / LV7=210 / LV8=280 / LV9=360 / LV10=450
- **最大レベル**: 99
...
- **ドラゴン**: RUINS_B2の固定位置に出現し、倒すとエンディングへ遷移
